...
In this paper, for convenience, the notation $||\,\cdot\,||$ is used instead of the Frobenius norm $||\,\cdot\,||_{F}$
and $\N_{0}$ is defined by $\N \cup \{0\}$ because they are used very frequently.
...
\end{equation}
is the Fr\'{e}chet derivative of the MPE \eqref{eq:MPE} at $X$ in the direction $H$,
and the second Fr\'{e}chet derivative at $X$ is given by
