...
\begin{enumerate}[1)]
	...
	\item $t \in [1, 2]$에 대해 우리가 원하는 $S$가 존재함을 보여야 하지 않나? {\color{red}$\longleftarrow$ 정확히는 $S$가 그 라인 {\bf 근처}에 놓여있다? 그걸 보여야하지 않나...}
\end{enumerate}
...
\begin{proof}
	...
	\begin{align*}
		...
		&\quad= P\left(\pjn(X_{i} + tH_{i}) + \pjm(S) \right) + D_{i},
	\end{align*}
	where 
	\begin{equation*}
	...
	\begin{align*}
		...
		&{\color{red}\leq \bar{c}\left\|(t-1)\pjm(\tXi) - t\pjm(\tXii)\right\|} \\
