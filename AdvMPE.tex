...
\begin{proof}
	...
	\begin{equation}
		(1-\e)\|\pjn(\tXi)\| \leq \|\tXi\| \leq (1+\e)\|\pjn(\tXi)\|
	\end{equation}
	For $t \in [1, 2]$,
	\begin{equation}
	...
	\begin{equation*}
		\pjn\tXi \geq 0,\quad \pjn\tXi = c_{i}E
	\end{equation*}
	...
	\begin{align*}
		...
		&= \|(1 - \a_{i})c_{i}E + \a_{i}c_{i+1}E\| + (\a_{i} - 1)\e c_{i}\|E\| + \a_{i}\e c_{i+1}\|E\| \\
		&= |(1 - \a_{i})c_{i} + \a_{i}c_{i+1}|\|E\| + (\a_{i} - 1)\e c_{i}\|E\| + \a_{i}\e c_{i+1}\|E\|
	\end{align*}
