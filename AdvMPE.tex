...
\section{Analysis for the Nearly Singular $M$-matrix $-\P'[S]$}\label{sec:nearlysingular}
...
Therefore, the eigenvalue $\e$ of $-\P'[S]$ whose absolute value is the smallest in absolute values of all eigenvalues is nonnegative and simple by \cite[Perron-Frobenius Theorem]{Horn1985}.
