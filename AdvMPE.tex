...
\begin{proof}
	...
	\begin{align*}
		\|S - X_{i} - \a_{i}H_{i}\| &= \|(1 - \a_{i})\tXi + \a_{i}\tXii\| \\
		&= \|(1 - \a_{i})\pjn\tXi + \a_{i}\pjn\tXii + (1 - \a_{i})\pjm\tXi + \a_{i}\pjm\tXii\| \\
		&\leq \|(1 - \a_{i})\pjn\tXi + \a_{i}\pjn\tXii\| + (\a_{i} - 1)\|\pjm\tXi\| + \a_{i}\|\pjm\tXii\| \\
		&\leq \|(1 - \a_{i})\pjn\tXi + \a_{i}\pjn\tXii\| + (\a_{i} - 1)\e\|\pjn\tXi\| + \a_{i}\e\|\pjn\tXii\| \\
		&= \|(1 - \a_{i})c_{i}E + \a_{i}c_{i+1}N\| + (\a_{i} - 1)\e c_{i}\|N\| + \a_{i}\e c_{i+1}\|N\| \\
		&= |(1 - \a_{i})c_{i} + \a_{i}c_{i+1}|\|N\| + (\a_{i} - 1)\e c_{i}\|N\| + \a_{i}\e c_{i+1}\|N\| \\
		&= |(1 - \a_{i})c_{i} + \a_{i}c_{i+1}| + \left((\a_{i} - 1)c_{i} + \a_{i} c_{i+1}\right)\e
	\end{align*}
...
%	\end{align*}}
	...
	Approach 3. $\dtyl\dashv \left|\frac{\|\tXi\|}{\|\tXii\|} - \frac{\a_{i}}{\a_{i} - 1}\right| < \gamma = \gamma(\e)$.
	
	\begin{equation}
		\frac{\|\tXi\|}{\|\tXii\|} \approx \nu \Longrightarrow \a = \frac{\nu}{\nu - 1}
	\end{equation}
