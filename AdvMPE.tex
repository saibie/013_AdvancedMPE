...
\begin{proof}
	...
	\begin{align*}
		&P(X_{i} + tH_{i}) \\
		&= \sum_{k=1}^{n} \frac{1}{k!}P^{(k)}[S]\left((t-1)\tXi - t\tXii\right) \\
		&= \sum_{k=1}^{n} \frac{1}{k!}P^{(k)}[S]\left(\pjn\left((t-1)\tXi - t\tXii\right) + \pjm\left((t-1)\tXi - t\tXii\right)\right)^{k} \\
		&= \sum_{k=1}^{n} \frac{1}{k!} \sum_{{\bf v}\in \{0,1\}^{k}}P^{(k)}[S]\Psi_{\left(\pjn\left((t-1)\tXi - t\tXii\right),~ \pjm\left((t-1)\tXi - t\tXii\right)\right)}({\bf v}) \\
		&= \sum_{k=1}^{n} \frac{1}{k!} P^{(k)}[S]\left(\pjn\left((t-1)\tXi - t\tXii\right)\right)^{k} + D_{i} \\
		&= \sum_{k=1}^{n} \frac{1}{k!} P^{(k)}[S]\left(\pjn(X_{i} + tH_{i}) + \pjm(S) - S\right)^{k} + D_{i} \\
		&= P\left(\pjn(X_{i} + tH_{i}) + \pjm(S) - S\right) + D_{i},
	\end{align*}
	where 
	\begin{equation*}
	...
	\begin{align*}
		&\text{2) }\|D_{i}\| \\
		&= \left\|\sum_{k=1}^{n} \frac{1}{k!} \sum_{{\bf v}\in \{0,1\}^{k} \setminus {\bf 0}}P^{(k)}[S]\Psi_{\left((t-1)\pjn(\tXi) - t\pjn(\tXii),~ (t-1)\pjm(\tXi) - t\pjm(\tXii)\right)}({\bf v})\right\| \\
		&\leq \sum_{k=1}^{n} \frac{1}{k!} \sum_{{\bf v}\in \{0,1\}^{k} \setminus {\bf 0}} \left\| P^{(k)}[S]\Psi_{\left((t-1)\pjn(\tXi) - t\pjn(\tXii),~ (t-1)\pjm(\tXi) - t\pjm(\tXii)\right)}({\bf v})\right\| \\
		...
		&< \sum_{k=1}^{n} \frac{1}{k!} \sum_{{\bf v}\in \{0,1\}^{k} \setminus {\bf 0}} \left\| P^{(k)}[S]\right\| \left(\left\|(t-1)\pjn(\tXi)\right\| + \left\|t\pjn(\tXii)\right\|\right)^{k - {\bf 1}^{T}{\bf v}} \left(\e\left\|(t-1)\pjn(\tXi)\right\| + \e\left\|t\pjn(\tXii)\right\|\right)^{{\bf 1}^{T}{\bf v}} \\
		...
		&= \sum_{k=1}^{n} \frac{1}{k!} \sum_{{\bf v}\in \{0,1\}^{k} \setminus {\bf 0}} \left\| P^{(k)}[S]\right\| \e^{{\bf 1}^{T}{\bf v}}\left((t-1)c_{i} + tc_{i+1}\right)^{k} \\
		&= \sum_{k=1}^{n} \frac{1}{k!} \sum_{l=1}^{k} \binom{k}{l}\left\|P^{(k)}[S]\right\| \e^{l}\left((t-1)c_{i} + tc_{i+1}\right)^{k} \\
		&= \sum_{k=1}^{n} \frac{1}{k!} \sum_{l=1}^{k} \binom{k}{l}\bar{p}_{k} \e^{l}\left((t-1)c_{i} + tc_{i+1}\right)^{k}
	\end{align*}
