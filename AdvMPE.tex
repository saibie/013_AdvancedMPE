...
\begin{proof}
	...
	\begin{align*}
		&P(X_{i} + tH_{i}) \\
		&\quad= \sum_{k=1}^{n} \frac{1}{k!}P^{(k)}[S]\left((t-1)\tXi - t\tXii\right) \\
...
\begin{proof}
	...
	\begin{align*}
		...
		\textrm{Approach 2. }& \dashv \|(1-\a_{i})\tXi + \a_{i}\tXii\| > \|\tXii\| \\
		&\qquad\Longrightarrow \exists t \in [1,2] \setminus \{\a_{i}\} ~;~ \|P(X_{i} + tH_{i})\| < \|P(X_{i} + \a_{i}H_{i})\| \\
...
%	\end{align*}}
	...
	\begin{align*}
		P(X_{i} + tH_{i}) &= P(S) + P'[S](X_{i} + tH_{i} - S) + O(\|X_{i} + tH_{i} - S\|^{2}) \\
		&= -P'[S]\left((1-t)\tXi + t\tXii\right) + O(\|(1-t)\tXi + t\tXii\|^{2})
	\end{align*}
	
	\begin{align*}
		P(X_{i} + tH_{i}) - P(X_{i} + \a_{i}H_{i}) &\geq P'[X_{i} + \a_{i}H_{i}]\left((t - \a_{i})H_{i}\right) \\
		&= -(t - \a_{i})P'[X_{i} + \a_{i}H_{i}]\left(P'[X_{i}]^{-1}(P(X_{i}))\right) 
	\end{align*}
	...
	\begin{align*}
		...
		&= -tP(X_{i}) \\
		P(X_{i} + tH_{i}) &\geq (1-t)P(X_{i})
	\end{align*}
	
	\begin{align*}
		P(X_{i+1}) - P(X_{i}) &\geq P'[X_{i}]\left(H_{i}\right) \\
		&= -P(X_{i}) \\
		P(X_{i+1}) &\geq 0
	\end{align*}
