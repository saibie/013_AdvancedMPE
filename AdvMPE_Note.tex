...
\begin{proof}
	...
	\begin{align*}
	F''[x_{0}](x_{0} - s)P_{N_{1}}(x_{0} - s) &= (F'[x_{0}] - F'[s])P_{N_{1}}(x_{0} - s) + \beta_{3}(x_{0})
	\end{align*}
	...
	\begin{align*}
		...
		&= \frac12 F'[x_{0}]^{-1}F''[x_{0}](x_{0} - s){\color{red}(P_{X_{1}}+P_{N_{1}})}(x_{0} - s) + \beta_{2}(x_{0}) \\
		&= \frac12 F'[x_{0}]^{-1}F''[x_{0}](x_{0} - s)P_{X_{1}}(x_{0} - s) + \frac12 F'[x_{0}]^{-1}F''[x_{0}](x_{0} - s)P_{N_{1}}(x_{0} - s) + \beta_{2}(x_{0}) \\
		&= \frac12 F'[x_{0}]^{-1}F''[x_{0}](x_{0} - s)P_{X_{1}}(x_{0} - s) + \frac12 F'[x_{0}]^{-1}(F'[x_{0}] - F'[s])P_{N_{1}}(x_{0} - s) + \beta_{2}(x_{0}) \\
		&= \frac12 F'[x_{0}]^{-1}F''[x_{0}](x_{0} - s)P_{X_{1}}(x_{0} - s) + \frac12 P_{N_{1}}(x_{0} - s) - \frac12 F'[x_{0}]^{-1}F'[s]P_{N_{1}}(x_{0} - s) + \beta_{2}(x_{0}) \\
		&= \frac12 F'[x_{0}]^{-1}F''[x_{0}](x_{0} - s)P_{X_{1}}(x_{0} - s) + \frac12 P_{N_{1}}(x_{0} - s) - \frac12 \l F'[x_{0}]^{-1}P_{N_{1}}(x_{0} - s) + \beta_{2}(x_{0}) 
	\end{align*}
	
%	{\bf\noindent Another approach.}	
%	\begin{align*}
%	x_{1} - s &= x_{0} - s - F'[x_{0}]^{-1}F(x_{0}) \\
%	&= \frac12 F'[x_{0}]^{-1}F''[x_{0}](x_{0} - s)^{2} + \beta_{2}(x_{0}) \\
%	&= \frac12 F'[x_{0}]^{-1}{\color{red}F''[x_{0}](x_{0} - s)}(x_{0} - s) + \beta_{2}(x_{0}) \\
%	&= \frac12 F'[x_{0}]^{-1}({\color{red}F'[x_{0}] - F'[s]})(x_{0} - s) + \beta_{2}(x_{0}) \\
%	&= \frac12 (x_{0} - s) + \frac12 F'[x_{0}]^{-1}F'[s](x_{0} - s) + \beta_{2}(x_{0}) \\
%	&= \frac12 (x_{0} - s) + \frac12 F'[x_{0}]^{-1}F'[s]{\color{red}(P_{X_{1}} + P_{N_{1}})}(x_{0} - s) + \beta_{2}(x_{0}) \\
%	&= \frac12 (x_{0} - s) + \frac12 F'[x_{0}]^{-1}F'[s]P_{X_{1}}(x_{0} - s) + \frac12 F'[x_{0}]^{-1}F'[s]P_{N_{1}}(x_{0} - s) + \beta_{2}(x_{0}) \\
%	&= \frac12 (x_{0} - s) + \frac12 F'[x_{0}]^{-1}F'[s]P_{X_{1}}(x_{0} - s) + \frac12\l  F'[x_{0}]^{-1}P_{N_{1}}(x_{0} - s) + \beta_{2}(x_{0})
%	\end{align*}
	
	\begin{align*}
		P_{X_{1}}(x_{1} - s) &= \frac12 (P_{X_{1}}F'[x_{0}]^{-1})F''[x_{0}](x_{0} - s)P_{X_{1}}(x_{0} - s) - \frac12 \l P_{X_{1}}F'[x_{0}]^{-1}P_{N_{1}}(x_{0} - s) + \beta_{2}(x_{0}) 
	\end{align*}
